  ...
  <form id="form">
    ...
    <div class="box box-primary">
          ...
          <div class="col-xs-3 form-group {!! $errors->has('fetching_protocol') ? 'has-error' : ''!!}"
            ...
            <div class="col-xs-2 form-group">
              <input type="checkbox" name="fetching_status"
                     id="fetching_status"> Enable Fetching
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-2 form-group">
              <input type="checkbox" name="sending_status"
                     id="sending_status">Enable Sending
            </div>
          </div>
        </div>
        <div class="row">
      ...
      <div class="box-footer">
        {!! Form::button('<i id="spin" class="fa fa-spinner" style="display:none;"></i> <b>Create</b>' ,['class'=>'btn btn-primary', 'type' => 'submit'])!!}
      </div>
    </div>
  </form>
