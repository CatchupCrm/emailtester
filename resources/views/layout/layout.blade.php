...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li @yield('create')><a href="{!! url('emails/create') !!}"><i class="fa fa-book"></i> <span>Create</span></a>
        </li>
        <li class="header">MAILBOX</li>
        <li @yield('inbox')><a href="{!! url('/') !!}"><i class="fa fa-circle-o text-aqua"></i> <span>Inbox</span></a>
        </li>
        <li @yield('read')><a href="{!! url('readmails') !!}"><i class="fa fa-circle-o text-aqua"></i>
            <span>Fetch Mails</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2016 <a href="https://www.faveohelpdesk.com"><b>FAVEO</b> HELPDESK</a>.</strong> All rights
    reserved. Powered by <img src="{{asset("lb-faveo/media/images/ladybird.png")}}">
  </footer>
